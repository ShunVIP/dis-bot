...
CATEGORIES = {
    ...
    "⏰ Напоминания": {
        ...
        "emoji": "⏰",
        "commands": [
            ("/напомни",            "Разовое или повторяющееся напоминание (роли, пользователи)"),
            ("/мои_напоминания",    "Активные напоминания с обратным отсчётом"),
            ("/удалить_напоминание","Удалить напоминание по ID"),
        ]
    },
    "🎲 Рандом": {
    ...
    "☢️ Активность": {
        ...
        "emoji": "☢️",
        "commands": [
            ("/токсики",            "Топ токсичных участников за неделю"),
            ("/итог_дня",           "Итог дня с хокку и статистикой"),
            ("/войс_роли_статус",   "Текущие авто-роли голосовых каналов"),
        ]
    },
}
...
ADMIN_CATEGORIES = {
    "🎭 Пародия (адм)": {
        ...
        "emoji": "🎭",
        "commands": [
            ("/дообучить",              "Обучить модели: Markovify / Persona / GPT"),
            ("/профилактика",           "Полный цикл: сброс → сбор → переобучение"),
    ...
    "⚙️ Система": {
        ...
        "emoji": "⚙️",
        "commands": [
            ("/токсичность_вкл",        "Включить/выключить детектор токсичности"),
            ("/токсичность_порог",      "Уровень чувствительности детектора"),
            ("/токсичность_канал",      "Каналы мониторинга токсичности"),
            ("/итог_дня_канал",         "Канал для авто-постинга итога дня"),
            ("/итог_дня_вкл",           "Включить/выключить авто-постинг итога"),
            ("/войс_роли_вкл",          "Включить/выключить авто-роли войса"),
            ("/релизы_канал",           "Канал уведомлений о релизах/скидках Steam"),
            ("/релизы_проверить",       "Проверить вишлисты Steam прямо сейчас"),
        ]
    },
}
